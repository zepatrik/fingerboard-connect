...
import { StyleSheet, View, ScrollView, Text , FlatList, Dimensions} from "react-native";
        ...
        <FlatList 
          ...
          renderItem={({item}) => ( 
            <View style={styles.cards}>
              ...
              <Text style={styles.dates}>{item.dates[0].toLocaleDateString()}</Text>
              <IoniconsIcon name="ios-time" style={styles.icontime}></IoniconsIcon>
              <Text style={styles.mins}>22min</Text>
              <IoniconsIcon name="md-trophy" style={styles.icontimes}></IoniconsIcon>
